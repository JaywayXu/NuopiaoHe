function Population = Selection(Population,N,Z,Zmin)
...
%--------------------------------------------------------------------------
    ...
    Pobjs = [Population.fitness1;Population.fitness2;Population.fitness3]';

    %% Non-dominated sorting
    [FrontNo,MaxFNo] = NDSort(Pobjs,N);
    Next = FrontNo < MaxFNo;
    Next = Next';
    %% Select the solutions in the last front
    Last   = find(FrontNo==MaxFNo);
    Last   = Last';
    Choose = LastSelection(Pobjs(Next,:),Pobjs(Last,:),N-sum(Next),Z,Zmin);
