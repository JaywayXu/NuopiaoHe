...
for i = 1:1:PN
    ...
    %%%%%%%%%%%%%%%问题1%%%%%%%%%%%%%%%%%%%%%%%
    [f1,f2,f3,f4] = Fitness4(len,chrom,F,Fit_List1,InterNum);
    POP(i).c = chrom;
    POP(i).l = len;
    POP(i).fitness1 = f1;
    POP(i).fitness2 = f2;
...
%         ss=length(cat(1,P{1,i}.l));
        ...
        for j=1:ss
            ...
            [f1,f2,f3,f4] = Fitness4(child(j).l,child(j).c,F,Fit_List1,InterNum);
            child(j).fitness1 = f1;
            child(j).fitness2 = f2;
            child(j).fitness3 = f3;
            child(j).fitness4 = f4;
